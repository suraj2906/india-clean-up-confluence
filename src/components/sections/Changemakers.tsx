...
export function Changemakers() {
  return (
    <section id="changemakers" className="scroll-mt-24 bg-sand py-24 sm:py-32">
          ...
          {changemakers.map((person, i) => (
            <Reveal as="li" key={person.name} delay={i * 0.07}>
              <article className="group h-full overflow-hidden rounded-4xl bg-white shadow-soft transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lift">
                <div className="relative aspect-4/5 overflow-hidden bg-leaf-100">
                  <SmartImage
                ...
                <div className="p-6">
                  ...
                  <p className="mt-1 text-xs font-semibold uppercase tracking-[0.12em] text-ocean">
                    {person.role}
                  </p>
