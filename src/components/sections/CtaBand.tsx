...
/**
 * The card carries its own top padding rather than relying on the section above
 * to leave room. `Partners` runs full-bleed to the edges of its band, so without
 * this the dark card started the moment that band ended.
 */
export function CtaBand() {
  return (
    <section className="bg-shell px-5 pb-24 pt-24 sm:pb-32 sm:pt-32 md:px-8">
      <Reveal>
