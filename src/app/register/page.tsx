...
export const metadata: Metadata = {
  title: "Register",
  description: `Register for ${site.fullName} 3.0 — open to volunteers, clean-up movements, corporates, students and press. NGOs can also apply to pitch at One CEO, Many Missions.`,
 ...
 *
 * The One CEO, Many Missions explanation used to be a section under it. It is
